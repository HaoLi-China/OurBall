...
import game.ourball.gameview.OnePlayerActivity;
 ...
 * 
 */
public class LevelView1 extends Activity {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK){
			...
			intent.setClass(LevelView1.this, MainView.class);
			LevelView1.this.startActivity(intent);
			System.exit(0);
		}
	...
	public void handleClick(int position){
		if(position<Constant.maxLevelForOne){
			Intent intent = new Intent();
			intent.putExtra("level", position);
			intent.setClass(LevelView1.this, OnePlayerActivity.class);
			LevelView1.this.startActivity(intent);
			System.exit(0);
			}
			else{
				Toast.makeText(LevelView1.this, "未解锁...",
